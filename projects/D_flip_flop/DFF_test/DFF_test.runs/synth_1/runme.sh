...
HD_PWD='C:/Users/rafat/OneDrive/Documents/FPGA/projects/D_flip_flop/DFF_test/DFF_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFF_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFF_Test.tcl
