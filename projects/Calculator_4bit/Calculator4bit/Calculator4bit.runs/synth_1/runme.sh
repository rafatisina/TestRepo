...
HD_PWD='C:/Users/rafat/OneDrive/Documents/FPGA/FPGA/projects/Calculator_4bit/Calculator4bit/Calculator4bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Simple_Calculator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Simple_Calculator.tcl
