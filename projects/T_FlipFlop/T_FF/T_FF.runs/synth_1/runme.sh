...
HD_PWD='C:/Users/rafat/OneDrive/Documents/FPGA/FPGA/projects/T_FlipFlop/T_FF/T_FF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log T_FFCode.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source T_FFCode.tcl
